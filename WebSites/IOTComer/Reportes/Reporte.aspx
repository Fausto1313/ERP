<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Reporte.aspx.cs" Inherits="Reportes_Reporte" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  Cliente Nuevo
    ...
    Bitácora que muestra el control de asistencia de empleados
    </div>
    <div class="row" >            
    ...
    <asp:GridView ID="GridView1" runat="server" Width="940px" HorizontalAlign="Center"
     ...
     <div>
        <a class="btn btn-danger" href="Bitacoras.aspx" runat="server" role="button">Volver</a>
         <asp:Button runat="server" ID="genera" OnClick="genera_Click" Text="Plesioname" CssClass="btn btn-success"/>
         <asp:Button runat="server" ID="generaPDF" OnClick="generaPDF_Click" Text="Plesioname 2" />
    </div>
</asp:Content>
