<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/IOT/SiteLog.master" CodeFile="HabilitaDisp.aspx.cs" Inherits="HabilitaDisp" %>
...
<a class="alert-link">Este catálogo se podrá Habilitar/Deshabilitar los dispositivos para el envio de mensajes vía telegram.
  <p>
...
<!--validaciones-->
    ...
    Text='<i class="glyphicon glyphicon-hdd icon-success"></i>' />
