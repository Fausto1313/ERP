...
using System.Linq;
public partial class IOT_Telegram : System.Web.UI.Page
{
    DataTable dt;
   static string conString = ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString;
    ...
    public void BindGrid()
    {
        ...
        conn.Open();
        SqlCommand cmd = new SqlCommand("SELECT ID, Usuario FROM Telegram where ID_Cliente=2", conn);
    ...
    private void ExecuteUpdateS(string id, int cliente)
    {
        ...
        con.Open();
        string updateCmd = "UPDATE Telegram SET ID_Cliente=@cliente WHERE ID=@id";
    ...
    public void registros(string id, string usuario)
    {
        ...
        int idc = 2;
        cmd.CommandText = "INSERT Telegram (ID, usuario,ID_Cliente) VALUES (@ID, @usuario, @idc)";
