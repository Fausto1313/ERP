<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/IOT/SiteLog.master" CodeFile="ReportesTemperatura.aspx.cs" Inherits="IOT_ReportesTemperatura" %>
     ...
     <asp:GridView ID="GridView1" runat="server" Width="940px" HorizontalAlign="Center"
        ...
        <Columns>
           ...
           <ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <asp:BoundField DataField="Temperatura" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Temperatura" SortExpression="Temperatura" HeaderStyle-ForeColor="White" HeaderStyle-BackColor=#0c4566>
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
           <ItemStyle HorizontalAlign="Center"></ItemStyle>
           </asp:BoundField>
         <asp:BoundField DataField="Humedad" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center" HeaderText="Humedad" SortExpression="Temperatura" HeaderStyle-ForeColor="White" HeaderStyle-BackColor=#0c4566>
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
           <ItemStyle HorizontalAlign="Center"></ItemStyle>
           </asp:BoundField>
        </Columns>
