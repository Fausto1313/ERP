<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/IOT/SiteLog.master" CodeFile="ReportesCorriente.aspx.cs" Inherits="IOT_ReportesCorriente" %>
     ...
     <asp:GridView ID="GridView1" runat="server" Width="940px" HorizontalAlign="Center"
        ...
        <Columns>
           ...
           <ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <asp:BoundField DataField="Amperaje" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Amperaje" SortExpression="Amperaje" HeaderStyle-ForeColor="White" HeaderStyle-BackColor=#0c4566>
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
           <ItemStyle HorizontalAlign="Center"></ItemStyle>
           </asp:BoundField>
         <asp:BoundField DataField="Voltaje" HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center" HeaderText="Voltaje" SortExpression="Voltaje" HeaderStyle-ForeColor="White" HeaderStyle-BackColor=#0c4566>
                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
           <ItemStyle HorizontalAlign="Center"></ItemStyle>
           </asp:BoundField>
