...
public partial class HabilitaDisp : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (permiso.returnPermiso(usuario, pantalla) == "HabilitarDisp")
        {
    ...
    public void BindGrid()
    {
        ...
        cn2.Open();
        SqlCommand cms = new SqlCommand("select distinct d.riscei, d.descripcion, d.estatus, d.ubidis from dars d, ubidis u where d.ubidis in (select u.id where cl_cliente = @cliente and cl_sitio = @sitio) and d.Modelo not in ('DAR-BIS-CC')", cn2);
