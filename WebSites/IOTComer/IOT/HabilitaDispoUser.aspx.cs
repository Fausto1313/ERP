...
public partial class IOT_HabilitaDispoUser : System.Web.UI.Page
{
    DataTable dt;
    ...
    public void BindGrid()
    {
        ...
        cn2.Open();
        SqlCommand cms = new SqlCommand("select distinct d.riscei, d.descripcion, d.estatus from dars d, ubidis u where d.ubidis in (select u.id where cl_sitio = @sitio) and d.Modelo not in ('DAR-BIS-CC')", cn2);
