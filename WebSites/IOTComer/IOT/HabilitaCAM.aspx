<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HabilitaCAM.aspx.cs" MasterPageFile="~/IOT/SiteLog.master" Inherits="IOT_HabilitaCAM" %>
...
<br /> 
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style="color:azure">Habilitar o deshabilitar Camaras</a>
    </div>
...
<a class="alert-link">Este catálogo se podrá Habilitar/Deshabilitar las camaras instaladas en el sitio.
  <p>
   ...
   <br />
    ...
    Text='<i class="glyphicon glyphicon-facetime-video icon-success"></i>' />
