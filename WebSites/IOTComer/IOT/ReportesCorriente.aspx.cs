...
public partial class IOT_ReportesCorriente : System.Web.UI.Page
{
    ...
    public void BindGrid()
    {
        ...
        if (riscei == null || riscei == "")
            riscei = "a";
        con.Open();
        SqlCommand cmd = new SqlCommand("select ID, RISCEI, Amperaje, Voltaje, Fecha from Electrico where RISCEI = @riscei", con);
