<%@ Page Title="" Language="C#" MasterPageFile="~/IOT/SiteLog.master" AutoEventWireup="true" CodeFile="AdministracionSubcategoria.aspx.cs" Inherits="IOT_AdministracionSubcategoria" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent2" Runat="Server">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style="color:azure">Administración Subcategorias</a>
    </div>
...
<a class="alert-link">Este catálogo se podrá realizar el alta de las subcategorias correspondiente del restaurante .
    <p>
        INSTRUCCION: Para realizar el alta de subcategorias dar clic en el botón verde y rellenar la información solicitada.
    </p>
    <p>
        Para mostrar la información de la tabla deberás seleccionar el filtro de categorias.
    </p>
</a>
        </div>
   ...
   <br />
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            ...
            <div class="row">
                ...
                <asp:Label runat="server"  AssociatedControlID="Cat" CssClass="col-md-1 control-label">Categoria</asp:Label>
                <div class="col-md-3">
                    
                    <asp:DropDownList runat="server" CssClass="form-control" BorderColor=#0c4566  ID="Cat" OnSelectedIndexChanged="Cat_SelectedIndexChanged" AutoPostBack="true"/>
                    <br>
                    <br />
                </div>
            ...
            <asp:GridView ID="GridView1" runat="server" width="940px" HorizontalAlign="Center" AutoGenerateColumns="false" 
                    AllowPaging="true" DataKeyNames="ID" CssClass="table table-hover table-striped" OnRowCommand="OnRowCommand" OnPageIndexChanging="PageIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
                ...
                <Columns>
                            ...
                            <asp:BoundField DataField="NombreSub" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Nombre SubCategoria" SortExpression="NombreSub" HeaderStyle-ForeColor="White" HeaderStyle-BackColor=#0c4566>
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                  <ItemStyle HorizontalAlign="Center"></ItemStyle>
                            </asp:BoundField>
    ...
    Text='<i class="glyphicon glyphicon-remove icon-success"></i>' />
                   ...
                   <asp:Button ID="btnAdd" runat="server"  ValidationGroup="agregar" OnClick="BtnAddClick" Text="Agregar SubCategoria" CssClass="btn btn-success" BorderStyle="Solid" Width="162px"/>
            <br />
                <br />
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            ...
                            <asp:Label ID="txtID" runat="server"  BorderColor=#0c4566></asp:Label>
                                ...
                                <tr>
                                    <td>Nombre Subcategoria : 
                            <asp:Label  runat="server" BorderColor=#0c4566></asp:Label>
                                        <asp:TextBox runat="server" CssClass="form-control" ID="txtNombreCate"> </asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    <td>Orden:
                                        <asp:DropDownList ID="Orden2"  CssClass="form-control" runat ="server"></asp:DropDownList>
                                        </td>
                                 </tr>
                                ...
                                <tr>
                                    <td>Categoria:
                                        ...
                                        <asp:DropDownList ID="Categoria2" CssClass="form-control" runat="server"></asp:DropDownList>
    ...
    <!-- Inicia Modal Para Nuevo Registro-->
            <div id="addModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                ...
                <div class="modal-header"  style="background-image: url('/recursos/std_themelet1_style2_bg.png'); background-repeat:repeat">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
                    <h3 id="addModalLabel" style="color:azure">Nueva Subcategoria</h3>
                </div>
                    ...
                    <ContentTemplate>
                        <div class="modal-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td>Categoria:
                                        <asp:DropDownList runat="server" CssClass="form-control" ID="Categoria" />
                                   ...
                                   <tr>
                                    <td>Icono:
                                       <asp:DropDownList runat="server" CssClass="form-control" ID="Icono" OnSelectedIndexChanged="Icono_SelectedIndexChanged"  AutoPostBack="true"  />
                                        <br />    
                                         <asp:Image runat="server" ID="Image1" Width="100" />
                                    </td>
                                </tr>                                                               
                            </table>
                        </div>
